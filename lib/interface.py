...
WEEKDAY_SAT = 0b01000000
WEEKDAY_FRI = 0b00100000
WEEKDAY_THU = 0b00010000
WEEKDAY_WED = 0b00001000
WEEKDAY_TUE = 0b00000100
WEEKDAY_MON = 0b00000010
WEEKDAY_SUN = 0b00000001

SCHED_SCHEDULE = 0b00010000
SCHED_CLOCK    = 0b00001000
SCHED_AM       = 0b00000100
SCHED_PM       = 0b00000010
SCHED_COLON    = 0b00000001
# fmt: on
